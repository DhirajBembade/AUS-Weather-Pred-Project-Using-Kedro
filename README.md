# AUS-Weather_Predictions :

## Overview

This is your new Kedro project, which was generated using 'kedro~=0.18.8', with the completed version of the [AusRainPred tutorial] and the data necessary to run the project.
